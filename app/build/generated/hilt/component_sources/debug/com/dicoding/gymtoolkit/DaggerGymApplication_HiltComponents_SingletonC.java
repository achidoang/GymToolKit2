...
import com.dicoding.gymtoolkit.di.AppModule_ProvideLocalUserManagerFactory;
import com.dicoding.gymtoolkit.di.AppModule_ProvideNewsApiFactory;
...
public final class DaggerGymApplication_HiltComponents_SingletonC {
  ...
  private static final class ActivityCImpl extends GymApplication_HiltComponents.ActivityC {
    ...
    public Set<String> getViewModelKeys() {
      return SetBuilder.<String>newSetBuilder(3).add(HomeViewModel_HiltModules_KeyModule_ProvideFactory.provide()).add(MainViewModel_HiltModules_KeyModule_ProvideFactory.provide()).add(OnBoardingViewModel_HiltModules_KeyModule_ProvideFactory.provide()).build();
    }
  ...
  private static final class ViewModelCImpl extends GymApplication_HiltComponents.ViewModelC {
    ...
    public Map<String, Provider<ViewModel>> getHiltViewModelMap() {
      return MapBuilder.<String, Provider<ViewModel>>newMapBuilder(3).put("com.dicoding.gymtoolkit.presentation.home.HomeViewModel", ((Provider) homeViewModelProvider)).put("com.dicoding.gymtoolkit.MainViewModel", ((Provider) mainViewModelProvider)).put("com.dicoding.gymtoolkit.presentation.onboarding.OnBoardingViewModel", ((Provider) onBoardingViewModelProvider)).build();
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // com.dicoding.gymtoolkit.presentation.home.HomeViewModel 
          return (T) new HomeViewModel(singletonCImpl.provideNewsUseCasesProvider.get());

          case 1: // com.dicoding.gymtoolkit.MainViewModel 
          return (T) new MainViewModel(singletonCImpl.provideAppEntryUseCasesProvider.get());

          case 2: // com.dicoding.gymtoolkit.presentation.onboarding.OnBoardingViewModel 
  ...
  private static final class SingletonCImpl extends GymApplication_HiltComponents.SingletonC {
    ...
    private void initialize(final ApplicationContextModule applicationContextModuleParam) {
      ...
      this.provideLocalUserManagerProvider = DoubleCheck.provider(new SwitchingProvider<LocalUserManager>(singletonCImpl, 4));
      this.provideAppEntryUseCasesProvider = DoubleCheck.provider(new SwitchingProvider<AppEntryUseCases>(singletonCImpl, 3));
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          ...
          return (T) AppModule_ProvideNewsUseCasesFactory.provideNewsUseCases(singletonCImpl.provideNewsRepositoryProvider.get());
          ...
          case 3: // com.dicoding.gymtoolkit.domain.usecases.app_entry.AppEntryUseCases 
          ...
          case 4: // com.dicoding.gymtoolkit.domain.manager.LocalUserManager 
